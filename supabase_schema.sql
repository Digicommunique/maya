...
-- Ensure all optional columns exist on existing tables if created prior
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS academic_term TEXT;
...
ALTER TABLE transactions ADD COLUMN IF NOT EXISTS is_edited BOOLEAN DEFAULT FALSE;
...
ALTER TABLE students ADD COLUMN IF NOT EXISTS edited_at TIMESTAMP WITH TIME ZONE;
ALTER TABLE students ADD COLUMN IF NOT EXISTS previous_data JSONB;
